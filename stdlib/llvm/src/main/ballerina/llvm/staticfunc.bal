...
public extern function LLVMAddSymbol(string symbolName, Pointer symbolValue) returns ();
//public extern function LLVMAddSymbol(BytePointer symbolName, Pointer symbolValue);
public extern function LLVMInitializeCore(LLVMPassRegistryRef r) returns ();
public extern function LLVMShutdown() returns ();
...
public extern function LLVMContextSetDiagnosticHandler(LLVMContextRef c, LLVMDiagnosticHandler handler, Pointer diagnosticContext) returns ();
...
public extern function LLVMContextSetYieldCallback(LLVMContextRef c, LLVMYieldCallback callback, Pointer opaqueHandle) returns ();
public extern function LLVMContextDispose(LLVMContextRef c) returns ();
...
public extern function LLVMDisposeModule(LLVMModuleRef m) returns ();
public extern function LLVMGetModuleIdentifier(LLVMModuleRef m, SizeTPointer len) returns BytePointer;
public extern function LLVMSetModuleIdentifier(LLVMModuleRef m, string ident, int len) returns ();
...
public extern function LLVMSetDataLayout(LLVMModuleRef m, string dataLayoutStr) returns ();
...
public extern function LLVMSetTarget(LLVMModuleRef m, string triple) returns ();
//public extern function LLVMSetTarget(LLVMModuleRef m, BytePointer triple);
public extern function LLVMDumpModule(LLVMModuleRef m) returns ();
...
public extern function LLVMSetModuleInlineAsm(LLVMModuleRef m, string asm) returns ();
...
public extern function LLVMGetNamedMetadataOperands(LLVMModuleRef m, string name, PointerPointer dest) returns ();
public extern function LLVMAddNamedMetadataOperand(LLVMModuleRef m, string name, LLVMValueRef val) returns ();
...
public extern function LLVMGetParamTypes0(LLVMTypeRef functionTy, PointerPointer dest) returns ();
public extern function LLVMGetParamTypes1(LLVMTypeRef functionTy, LLVMTypeRef dest) returns ();
...
public extern function LLVMStructSetBody0(LLVMTypeRef structTy, LLVMTypeRef elementTypes, int elementCount, int packed) returns ();
public extern function LLVMStructSetBody1(LLVMTypeRef structTy, PointerPointer elementTypes, int elementCount, int packed) returns ();
public extern function LLVMCountStructElementTypes(LLVMTypeRef structTy) returns int;
public extern function LLVMGetStructElementTypes0(LLVMTypeRef structTy, LLVMTypeRef dest) returns ();
public extern function LLVMGetStructElementTypes1(LLVMTypeRef structTy, PointerPointer dest) returns ();
...
public extern function LLVMGetSubtypes0(LLVMTypeRef tp, PointerPointer arr) returns ();
public extern function LLVMGetSubtypes1(LLVMTypeRef tp, LLVMTypeRef arr) returns ();
...
public extern function LLVMSetValueName(LLVMValueRef val, string name) returns ();
public extern function LLVMDumpValue(LLVMValueRef val) returns ();
public extern function LLVMPrintValueToString(LLVMValueRef val) returns BytePointer;
public extern function LLVMReplaceAllUsesWith(LLVMValueRef oldVal, LLVMValueRef newVal) returns ();
...
public extern function LLVMSetOperand(LLVMValueRef user, int index, LLVMValueRef val) returns ();
...
public extern function LLVMSetLinkage(LLVMValueRef global, int linkage) returns ();
public extern function LLVMGetSection(LLVMValueRef global) returns BytePointer;
public extern function LLVMSetSection(LLVMValueRef global, string section) returns ();
...
public extern function LLVMSetVisibility(LLVMValueRef global, int viz) returns ();
public extern function LLVMGetDLLStorageClass(LLVMValueRef global) returns int;
public extern function LLVMSetDLLStorageClass(LLVMValueRef global, int classValue) returns ();
public extern function LLVMHasUnnamedAddr(LLVMValueRef global) returns int;
public extern function LLVMSetUnnamedAddr(LLVMValueRef global, int hasUnnamedAddr) returns ();
public extern function LLVMGetAlignment(LLVMValueRef v) returns int;
public extern function LLVMSetAlignment(LLVMValueRef v, int bytes) returns ();
...
public extern function LLVMDeleteGlobal(LLVMValueRef globalVar) returns ();
public extern function LLVMGetInitializer(LLVMValueRef globalVar) returns LLVMValueRef;
public extern function LLVMSetInitializer(LLVMValueRef globalVar, LLVMValueRef constantVal) returns ();
public extern function LLVMIsThreadLocal(LLVMValueRef globalVar) returns int;
public extern function LLVMSetThreadLocal(LLVMValueRef globalVar, int isThreadLocal) returns ();
public extern function LLVMIsGlobalConstant(LLVMValueRef globalVar) returns int;
public extern function LLVMSetGlobalConstant(LLVMValueRef globalVar, int isConstant) returns ();
public extern function LLVMGetThreadLocalMode(LLVMValueRef globalVar) returns int;
public extern function LLVMSetThreadLocalMode(LLVMValueRef globalVar, int mode) returns ();
public extern function LLVMIsExternallyInitialized(LLVMValueRef globalVar) returns int;
public extern function LLVMSetExternallyInitialized(LLVMValueRef globalVar, int isExtInit) returns ();
...
public extern function LLVMDeleteFunction(LLVMValueRef fn) returns ();
...
public extern function LLVMSetPersonalityFn(LLVMValueRef fn, LLVMValueRef personalityFn) returns ();
...
public extern function LLVMSetFunctionCallConv(LLVMValueRef fn, int cc) returns ();
...
public extern function LLVMSetGC(LLVMValueRef fn, string name) returns ();
public extern function LLVMAddAttributeAtIndex(LLVMValueRef f, int idx, LLVMAttributeRef a) returns ();
public extern function LLVMGetAttributeCountAtIndex(LLVMValueRef f, int idx) returns int;
public extern function LLVMGetAttributesAtIndex0(LLVMValueRef f, int idx, PointerPointer attrs) returns ();
public extern function LLVMGetAttributesAtIndex1(LLVMValueRef f, int idx, LLVMAttributeRef attrs) returns ();
...
public extern function LLVMRemoveEnumAttributeAtIndex(LLVMValueRef f, int idx, int kindID) returns ();
//public extern function LLVMRemoveStringAttributeAtIndex(LLVMValueRef f, int idx, BytePointer k, int kLen);
public extern function LLVMRemoveStringAttributeAtIndex(LLVMValueRef f, int idx, string k, int kLen) returns ();
public extern function LLVMAddTargetDependentFunctionAttr(LLVMValueRef fn, string a, string v) returns ();
...
public extern function LLVMGetParams0(LLVMValueRef fn, PointerPointer params) returns ();
public extern function LLVMGetParams1(LLVMValueRef fn, LLVMValueRef params) returns ();
...
public extern function LLVMSetParamAlignment(LLVMValueRef arg, int align) returns ();
...
public extern function LLVMGetMDNodeOperands0(LLVMValueRef v, LLVMValueRef dest) returns ();
public extern function LLVMGetMDNodeOperands1(LLVMValueRef v, PointerPointer dest) returns ();
...
public extern function LLVMGetBasicBlocks0(LLVMValueRef fn, LLVMBasicBlockRef basicBlocks) returns ();
public extern function LLVMGetBasicBlocks1(LLVMValueRef fn, PointerPointer basicBlocks) returns ();
...
public extern function LLVMDeleteBasicBlock(LLVMBasicBlockRef bb) returns ();
public extern function LLVMRemoveBasicBlockFromParent(LLVMBasicBlockRef bb) returns ();
public extern function LLVMMoveBasicBlockBefore(LLVMBasicBlockRef bb, LLVMBasicBlockRef movePos) returns ();
public extern function LLVMMoveBasicBlockAfter(LLVMBasicBlockRef bb, LLVMBasicBlockRef movePos) returns ();
...
public extern function LLVMSetMetadata(LLVMValueRef val, int kindID, LLVMValueRef node) returns ();
...
public extern function LLVMInstructionRemoveFromParent(LLVMValueRef inst) returns ();
public extern function LLVMInstructionEraseFromParent(LLVMValueRef inst) returns ();
...
public extern function LLVMSetInstructionCallConv(LLVMValueRef instr, int cc) returns ();
public extern function LLVMGetInstructionCallConv(LLVMValueRef instr) returns int;
public extern function LLVMSetInstrParamAlignment(LLVMValueRef instr, int index, int align) returns ();
public extern function LLVMAddCallSiteAttribute(LLVMValueRef c, int idx, LLVMAttributeRef a) returns ();
public extern function LLVMGetCallSiteAttributeCount(LLVMValueRef c, int idx) returns int;
public extern function LLVMGetCallSiteAttributes0(LLVMValueRef c, int idx, PointerPointer attrs) returns ();
public extern function LLVMGetCallSiteAttributes1(LLVMValueRef c, int idx, LLVMAttributeRef attrs) returns ();
...
public extern function LLVMRemoveCallSiteEnumAttribute(LLVMValueRef c, int idx, int kindID) returns ();
//public extern function LLVMRemoveCallSiteStringAttribute(LLVMValueRef c, int idx, BytePointer k, int kLen);
public extern function LLVMRemoveCallSiteStringAttribute(LLVMValueRef c, int idx, string k, int kLen) returns ();
...
public extern function LLVMSetTailCall(LLVMValueRef callInst, int isTailCall) returns ();
...
public extern function LLVMSetNormalDest(LLVMValueRef invokeInst, LLVMBasicBlockRef b) returns ();
public extern function LLVMSetUnwindDest(LLVMValueRef invokeInst, LLVMBasicBlockRef b) returns ();
...
public extern function LLVMSetSuccessor(LLVMValueRef term, int i, LLVMBasicBlockRef block) returns ();
...
public extern function LLVMSetCondition(LLVMValueRef branch, LLVMValueRef cond) returns ();
...
public extern function LLVMSetIsInBounds(LLVMValueRef gep, int inBounds) returns ();
public extern function LLVMAddIncoming0(LLVMValueRef phiNode, LLVMValueRef incomingValues, LLVMBasicBlockRef incomingBlocks, int count) returns ();
public extern function LLVMAddIncoming1(LLVMValueRef phiNode, PointerPointer incomingValues, PointerPointer incomingBlocks, int count) returns ();
...
public extern function LLVMPositionBuilder(LLVMBuilderRef builder, LLVMBasicBlockRef block, LLVMValueRef instr) returns ();
public extern function LLVMPositionBuilderBefore(LLVMBuilderRef builder, LLVMValueRef instr) returns ();
public extern function LLVMPositionBuilderAtEnd(LLVMBuilderRef builder, LLVMBasicBlockRef block) returns ();
public extern function LLVMGetInsertBlock(LLVMBuilderRef builder) returns LLVMBasicBlockRef;
public extern function LLVMClearInsertionPosition(LLVMBuilderRef builder) returns ();
public extern function LLVMInsertIntoBuilder(LLVMBuilderRef builder, LLVMValueRef instr) returns ();
public extern function LLVMInsertIntoBuilderWithName(LLVMBuilderRef builder, LLVMValueRef instr, string name) returns ();
//public extern function LLVMInsertIntoBuilderWithName(LLVMBuilderRef builder, LLVMValueRef instr, BytePointer name);
public extern function LLVMDisposeBuilder(LLVMBuilderRef builder) returns ();
public extern function LLVMSetCurrentDebugLocation(LLVMBuilderRef builder, LLVMValueRef l) returns ();
public extern function LLVMGetCurrentDebugLocation(LLVMBuilderRef builder) returns LLVMValueRef;
public extern function LLVMSetInstDebugLocation(LLVMBuilderRef builder, LLVMValueRef inst) returns ();
...
public extern function LLVMAddCase(LLVMValueRef switchValue, LLVMValueRef onVal, LLVMBasicBlockRef dest) returns ();
public extern function LLVMAddDestination(LLVMValueRef indirectBr, LLVMBasicBlockRef dest) returns ();
...
public extern function LLVMAddClause(LLVMValueRef landingPad, LLVMValueRef clauseVal) returns ();
public extern function LLVMIsCleanup(LLVMValueRef landingPad) returns int;
public extern function LLVMSetCleanup(LLVMValueRef landingPad, int val) returns ();
...
public extern function LLVMSetVolatile(LLVMValueRef memoryAccessInst, int isVolatile) returns ();
public extern function LLVMGetOrdering(LLVMValueRef memoryAccessInst) returns int;
public extern function LLVMSetOrdering(LLVMValueRef memoryAccessInst, int ordering) returns ();
...
public extern function LLVMSetAtomicSingleThread(LLVMValueRef atomicInst, int singleThread) returns ();
public extern function LLVMGetCmpXchgSuccessOrdering(LLVMValueRef cmpXchgInst) returns int;
public extern function LLVMSetCmpXchgSuccessOrdering(LLVMValueRef cmpXchgInst, int ordering) returns ();
public extern function LLVMGetCmpXchgFailureOrdering(LLVMValueRef cmpXchgInst) returns int;
public extern function LLVMSetCmpXchgFailureOrdering(LLVMValueRef cmpXchgInst, int ordering) returns ();
public extern function LLVMCreateModuleProviderForExistingModule(LLVMModuleRef m) returns LLVMModuleProviderRef;
public extern function LLVMDisposeModuleProvider(LLVMModuleProviderRef m) returns ();
...
public extern function LLVMDisposeMemoryBuffer(LLVMMemoryBufferRef memBuf) returns ();
...
public extern function LLVMDisposePassManager(LLVMPassManagerRef pm) returns ();
public extern function LLVMStartMultithreaded() returns int;
public extern function LLVMStopMultithreaded() returns ();
...
public extern function LLVMViewFunctionCFG(LLVMValueRef fn) returns ();
public extern function LLVMViewFunctionCFGOnly(LLVMValueRef fn) returns ();
...
public extern function LLVMDisasmDispose(LLVMDisasmContextRef dc) returns ();
...
public extern function LLVMInitializeTransformUtils(LLVMPassRegistryRef r) returns ();
public extern function LLVMInitializeScalarOpts(LLVMPassRegistryRef r) returns ();
public extern function LLVMInitializeObjCARCOpts(LLVMPassRegistryRef r) returns ();
public extern function LLVMInitializeVectorization(LLVMPassRegistryRef r) returns ();
public extern function LLVMInitializeInstCombine(LLVMPassRegistryRef r) returns ();
public extern function LLVMInitializeIPO(LLVMPassRegistryRef r) returns ();
public extern function LLVMInitializeInstrumentation(LLVMPassRegistryRef r) returns ();
public extern function LLVMInitializeAnalysis(LLVMPassRegistryRef r) returns ();
public extern function LLVMInitializeIPA(LLVMPassRegistryRef r) returns ();
public extern function LLVMInitializeCodeGen(LLVMPassRegistryRef r) returns ();
public extern function LLVMInitializeTarget(LLVMPassRegistryRef r) returns ();
...
public extern function LLVMDisposeObjectFile(LLVMObjectFileRef objectFile) returns ();
public extern function LLVMGetSections(LLVMObjectFileRef objectFile) returns LLVMSectionIteratorRef;
public extern function LLVMDisposeSectionIterator(LLVMSectionIteratorRef si) returns ();
public extern function LLVMIsSectionIteratorAtEnd(LLVMObjectFileRef objectFile, LLVMSectionIteratorRef si) returns int;
public extern function LLVMMoveToNextSection(LLVMSectionIteratorRef si) returns ();
public extern function LLVMMoveToContainingSection(LLVMSectionIteratorRef sect, LLVMSymbolIteratorRef sym) returns ();
public extern function LLVMGetSymbols(LLVMObjectFileRef objectFile) returns LLVMSymbolIteratorRef;
public extern function LLVMDisposeSymbolIterator(LLVMSymbolIteratorRef si) returns ();
public extern function LLVMIsSymbolIteratorAtEnd(LLVMObjectFileRef objectFile, LLVMSymbolIteratorRef si) returns int;
public extern function LLVMMoveToNextSymbol(LLVMSymbolIteratorRef si) returns ();
...
public extern function LLVMDisposeRelocationIterator(LLVMRelocationIteratorRef ri) returns ();
...
public extern function LLVMMoveToNextRelocation(LLVMRelocationIteratorRef ri) returns ();
...
public extern function LLVMInitializeAllTargetInfos() returns ();
public extern function LLVMInitializeAllTargets() returns ();
public extern function LLVMInitializeAllTargetMCs() returns ();
public extern function LLVMInitializeAllAsmPrinters() returns ();
public extern function LLVMInitializeAllAsmParsers() returns ();
public extern function LLVMInitializeAllDisassemblers() returns ();
...
public extern function LLVMSetModuleDataLayout(LLVMModuleRef m, LLVMTargetDataRef dl) returns ();
...
public extern function LLVMDisposeTargetData(LLVMTargetDataRef td) returns ();
public extern function LLVMAddTargetLibraryInfo(LLVMTargetLibraryInfoRef tli, LLVMPassManagerRef pm) returns ();
...
public extern function LLVMDisposeTargetMachine(LLVMTargetMachineRef t) returns ();
...
public extern function LLVMSetTargetMachineAsmVerbosity(LLVMTargetMachineRef t, int verboseAsm) returns ();
...
public extern function LLVMAddAnalysisPasses(LLVMTargetMachineRef t, LLVMPassManagerRef pm) returns ();
public extern function LLVMLinkInMCJIT() returns ();
public extern function LLVMLinkInInterpreter() returns ();
...
public extern function LLVMDisposeGenericValue(LLVMGenericValueRef genVal) returns ();
...
public extern function LLVMInitializeMCJITCompilerOptions(LLVMMCJITCompilerOptions options, int sizeOfOptions) returns ();
...
public extern function LLVMDisposeExecutionEngine(LLVMExecutionEngineRef ee) returns ();
public extern function LLVMRunStaticConstructors(LLVMExecutionEngineRef ee) returns ();
public extern function LLVMRunStaticDestructors(LLVMExecutionEngineRef ee) returns ();
...
public extern function LLVMFreeMachineCodeForFunction(LLVMExecutionEngineRef ee, LLVMValueRef f) returns ();
public extern function LLVMAddModule(LLVMExecutionEngineRef ee, LLVMModuleRef m) returns ();
...
public extern function LLVMAddGlobalMapping(LLVMExecutionEngineRef ee, LLVMValueRef global, Pointer addr) returns ();
...
public extern function LLVMDisposeMCJITMemoryManager(LLVMMCJITMemoryManagerRef mm) returns ();
public extern function LLVMAddArgumentPromotionPass(LLVMPassManagerRef pm) returns ();
public extern function LLVMAddConstantMergePass(LLVMPassManagerRef pm) returns ();
public extern function LLVMAddCalledValuePropagationPass(LLVMPassManagerRef pm) returns ();
public extern function LLVMAddDeadArgEliminationPass(LLVMPassManagerRef pm) returns ();
public extern function LLVMAddFunctionAttrsPass(LLVMPassManagerRef pm) returns ();
public extern function LLVMAddFunctionInliningPass(LLVMPassManagerRef pm) returns ();
public extern function LLVMAddAlwaysInlinerPass(LLVMPassManagerRef pm) returns ();
public extern function LLVMAddGlobalDCEPass(LLVMPassManagerRef pm) returns ();
public extern function LLVMAddGlobalOptimizerPass(LLVMPassManagerRef pm) returns ();
public extern function LLVMAddIPConstantPropagationPass(LLVMPassManagerRef pm) returns ();
public extern function LLVMAddPruneEHPass(LLVMPassManagerRef pm) returns ();
public extern function LLVMAddIPSCCPPass(LLVMPassManagerRef pm) returns ();
public extern function LLVMAddInternalizePass(LLVMPassManagerRef arg0, int allButMain) returns ();
public extern function LLVMAddStripDeadPrototypesPass(LLVMPassManagerRef pm) returns ();
public extern function LLVMAddStripSymbolsPass(LLVMPassManagerRef pm) returns ();
public extern function LLVMPassManagerBuilderCreate() returns LLVMPassManagerBuilderRef;
public extern function LLVMPassManagerBuilderDispose(LLVMPassManagerBuilderRef pmb) returns ();
public extern function LLVMPassManagerBuilderSetOptLevel(LLVMPassManagerBuilderRef pmb, int optLevel) returns ();
public extern function LLVMPassManagerBuilderSetSizeLevel(LLVMPassManagerBuilderRef pmb, int sizeLevel) returns ();
public extern function LLVMPassManagerBuilderSetDisableUnitAtATime(LLVMPassManagerBuilderRef pmb, int value) returns ();
public extern function LLVMPassManagerBuilderSetDisableUnrollLoops(LLVMPassManagerBuilderRef pmb, int value) returns ();
public extern function LLVMPassManagerBuilderSetDisableSimplifyLibCalls(LLVMPassManagerBuilderRef pmb, int value) returns ();
public extern function LLVMPassManagerBuilderUseInlinerWithThreshold(LLVMPassManagerBuilderRef pmb, int threshold) returns ();
public extern function LLVMPassManagerBuilderPopulateFunctionPassManager(LLVMPassManagerBuilderRef pmb, LLVMPassManagerRef pm) returns ();
public extern function LLVMPassManagerBuilderPopulateModulePassManager(LLVMPassManagerBuilderRef pmb, LLVMPassManagerRef pm) returns ();
public extern function LLVMPassManagerBuilderPopulateLTOPassManager(LLVMPassManagerBuilderRef pmb, LLVMPassManagerRef pm, int internalize, int runInliner) returns ();
public extern function LLVMAddAggressiveDCEPass(LLVMPassManagerRef pm) returns ();
public extern function LLVMAddBitTrackingDCEPass(LLVMPassManagerRef pm) returns ();
public extern function LLVMAddAlignmentFromAssumptionsPass(LLVMPassManagerRef pm) returns ();
public extern function LLVMAddCFGSimplificationPass(LLVMPassManagerRef pm) returns ();
public extern function LLVMAddDeadStoreEliminationPass(LLVMPassManagerRef pm) returns ();
public extern function LLVMAddScalarizerPass(LLVMPassManagerRef pm) returns ();
public extern function LLVMAddMergedLoadStoreMotionPass(LLVMPassManagerRef pm) returns ();
public extern function LLVMAddGVNPass(LLVMPassManagerRef pm) returns ();
public extern function LLVMAddNewGVNPass(LLVMPassManagerRef pm) returns ();
public extern function LLVMAddIndVarSimplifyPass(LLVMPassManagerRef pm) returns ();
public extern function LLVMAddInstructionCombiningPass(LLVMPassManagerRef pm) returns ();
public extern function LLVMAddJumpThreadingPass(LLVMPassManagerRef pm) returns ();
public extern function LLVMAddLICMPass(LLVMPassManagerRef pm) returns ();
public extern function LLVMAddLoopDeletionPass(LLVMPassManagerRef pm) returns ();
public extern function LLVMAddLoopIdiomPass(LLVMPassManagerRef pm) returns ();
public extern function LLVMAddLoopRotatePass(LLVMPassManagerRef pm) returns ();
public extern function LLVMAddLoopRerollPass(LLVMPassManagerRef pm) returns ();
public extern function LLVMAddLoopUnrollPass(LLVMPassManagerRef pm) returns ();
public extern function LLVMAddLoopUnswitchPass(LLVMPassManagerRef pm) returns ();
public extern function LLVMAddMemCpyOptPass(LLVMPassManagerRef pm) returns ();
public extern function LLVMAddPartiallyInlineLibCallsPass(LLVMPassManagerRef pm) returns ();
public extern function LLVMAddLowerSwitchPass(LLVMPassManagerRef pm) returns ();
public extern function LLVMAddPromoteMemoryToRegisterPass(LLVMPassManagerRef pm) returns ();
public extern function LLVMAddReassociatePass(LLVMPassManagerRef pm) returns ();
public extern function LLVMAddSCCPPass(LLVMPassManagerRef pm) returns ();
public extern function LLVMAddScalarReplAggregatesPass(LLVMPassManagerRef pm) returns ();
public extern function LLVMAddScalarReplAggregatesPassSSA(LLVMPassManagerRef pm) returns ();
public extern function LLVMAddScalarReplAggregatesPassWithThreshold(LLVMPassManagerRef pm, int threshold) returns ();
public extern function LLVMAddSimplifyLibCallsPass(LLVMPassManagerRef pm) returns ();
public extern function LLVMAddTailCallEliminationPass(LLVMPassManagerRef pm) returns ();
public extern function LLVMAddConstantPropagationPass(LLVMPassManagerRef pm) returns ();
public extern function LLVMAddDemoteMemoryToRegisterPass(LLVMPassManagerRef pm) returns ();
public extern function LLVMAddVerifierPass(LLVMPassManagerRef pm) returns ();
public extern function LLVMAddCorrelatedValuePropagationPass(LLVMPassManagerRef pm) returns ();
public extern function LLVMAddEarlyCSEPass(LLVMPassManagerRef pm) returns ();
public extern function LLVMAddEarlyCSEMemSSAPass(LLVMPassManagerRef pm) returns ();
public extern function LLVMAddLowerExpectIntrinsicPass(LLVMPassManagerRef pm) returns ();
public extern function LLVMAddTypeBasedAliasAnalysisPass(LLVMPassManagerRef pm) returns ();
public extern function LLVMAddScopedNoAliasAAPass(LLVMPassManagerRef pm) returns ();
public extern function LLVMAddBasicAliasAnalysisPass(LLVMPassManagerRef pm) returns ();
public extern function LLVMAddBBVectorizePass(LLVMPassManagerRef pm) returns ();
public extern function LLVMAddLoopVectorizePass(LLVMPassManagerRef pm) returns ();
public extern function LLVMAddSLPVectorizePass(LLVMPassManagerRef pm) returns ();
